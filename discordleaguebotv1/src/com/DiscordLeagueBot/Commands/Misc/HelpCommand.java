...
public class HelpCommand implements Command {
    ...
    public void action(String[] args, GuildMessageReceivedEvent e) {
        ...
        embed.setAuthor("Discord LeagueBot", "http://www.com.DiscordLeagueBot.DiscordLeagueBot.com", e.getJDA().getSelfUser().getAvatarUrl());
        ...
        DiscordLeagueBot.sendMessage(e.getChannel(), "Check your DM's!");
